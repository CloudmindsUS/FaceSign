...
//Source: "..\..\NewFaceLib\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
//Source: "..\..\TraffLib\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "C:\Users\harix\CITMS\IR_G120\*"; DestDir: "{app}\IR_G120"; Flags: ignoreversion recursesubdirs createallsubdirs
